  ...
  return (
    <div className="container-wide px-4 py-10 space-y-8">
      ...
      <div className="border shadow-md p-4 bg-gradient-to-t from-gray-100 to-primary-light rounded-xl space-y-4">
        ...
        {activeSubjectId && subjects && (
          <div className="bg-primary-red flex items-center gap-4 rounded-lg p-4 border max-w-md">
            ...
            <div className="flex items-center gap-2">
              <span className="text-sm text-gray-100">Weight</span>
              <input
                type="number"
                min={0}
                max={100}
                ...
                className="w-20 input text-center bg-white border-gray-300 rounded-md"
              />
